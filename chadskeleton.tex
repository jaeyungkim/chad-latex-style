...
% Optional: add publication and URL information at the bottom of the title
% page.  Replace the argument with the URL where your paper can be
% accessed; optionally provide a journal or venue name in square brackets.
% Example: \available[Journal Name]{http://your-url.com}
\available{http://example.com/yourpaper}
\maketitle
\thispagestyle{empty}
